...
```leaflet  
id: Nymeria ### Must be unique with no spaces  
image: [[Nymeria.jpg]] ### Link to the map image file  
bounds: [[0,0], [2304, 4096]] ### Size of the map in px Width_x, Height_y  
...
scale: 0.02374 ### Only required if you are using the measurement tool. Real units/px (resolution) of your map  
recenter: false  
